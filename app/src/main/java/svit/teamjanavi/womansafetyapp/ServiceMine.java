package svit.teamjanavi.womansafetyapp;
                ...
                .addOnSuccessListener(new OnSuccessListener<Location>() {
                    ...
                    public void onSuccess(Location location) {
                        if (location != null) {
                            ...
                            myLocation = "http://maps.google.com/maps?q=loc:"+location.getAltitude()+","+location.getLongitude();
                        }else {
                            myLocation = "I'm in Trouble\n" +
                                    "Maps: https://maps.app.goo.gl/kc9mU2rPAQosmVCr9 \n" +
                                    "Altitude: 13.167615\n" +
                                    "Longitude: 77.558273";
                        }
//                        SVIT
